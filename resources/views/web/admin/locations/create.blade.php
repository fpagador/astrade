...
@section('content')
    <h1 class="text-2xl font-semibold mb-6">Nueva Ubicación</h1>
    ...
    <x-form.form-wrapper action="{{ route('admin.locations.store') }}" method="POST" class="max-w-lg mx-auto bg-white p-6 rounded shadow">
